...
#Okan Sen
##
## Notes for coder: Use this read array for monitor since it doesn't take 0 as size. Add bubble sort's read array's negative values as well
#################################
...
return:
	...
	move $a0, $s1		# print integer result
	li $v0, 1			# using syscall 1
	syscall
